...
**Question:** In the Diffie-Hellman key exchange, Alice sends g^x mod p to Bob, and Bob sends g^y mod p to Alice. How do they get a common secret?

**Answer:** In this case, Alice will have the information Bob send her and x. Bob will have what Alice send him and y. Alice could take the information, raise it to the power of x and like g^y^x mod p and Bob could do g^x^y mod p. Through the power rule, we know g^x^y == g^y^x == g^xy. Therefore, without knowing the other person's secret information, x or y, Bob and Alice could get the common secret.
